    ...
    <div className="auth-page">
      <div className="auth-panel">
        ...
        <div className="auth-side">
          ...
          <h2 className="auth-side-title">¡Hola, Bienvenido!</h2>
          <p className="auth-side-text">¿No tienes una cuenta?</p>
          <Link to="/registro" className="auth-side-btn">
            Registrarse
          </Link>
        </div>
        ...
        <div className="auth-content">
          ...
          <p className="auth-social-label">o Iniciar Sesión con Google</p>
